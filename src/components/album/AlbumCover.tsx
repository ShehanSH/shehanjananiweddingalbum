...
export function AlbumCover({
  ...
  return (
    <div className="album-page flex h-full min-h-0 flex-col items-center justify-center px-4 pb-16 pt-5 text-center sm:px-8 sm:pb-16 sm:pt-8">
      ...
      <p className="shrink-0 text-[10px] tracking-[0.42em] uppercase text-sage-deep sm:text-[11px]">The Wedding Album</p>

      <h1 className="mt-3 shrink-0 font-script text-4xl text-brown sm:mt-5 sm:text-7xl">{COUPLE.groom}</h1>
      <p className="my-1 shrink-0 font-serif text-lg text-blush sm:my-2 sm:text-2xl">&</p>
      <h1 className="shrink-0 font-script text-4xl text-brown sm:text-7xl">{COUPLE.bride}</h1>

      {photo ? (
        <div className="mt-3 min-h-0 w-[62%] max-h-[46%] flex-1 overflow-hidden sm:mt-5 sm:w-44 sm:max-h-[38%]">
          <PhotoFrame
            photo={photo}
